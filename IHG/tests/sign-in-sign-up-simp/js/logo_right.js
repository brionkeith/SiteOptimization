jQuery(document).ready(function(jQuery) {
  ...
  jQuery('#frmGuestInfo #identityBlock .heavyText:eq(1)').html('This reservation could earn you ' + '<strong>' + POINTS + ' points</strong>' + ' toward a free night.'); // Change default text and add POINTS var
  jQuery('#frmGuestInfo #identityBlock #anonId .joinnowtext label').html('<strong>Sign me up now.</strong> Look for your new member info on the confirmation page. <br>Read the<a href=\"#\" class=\"pcrTerms\"> IHG&reg; Rewards Club Terms &amp; Conditions.</a>'); // Change default HTML text
