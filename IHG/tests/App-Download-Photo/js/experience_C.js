jQuery(document).ready(function ($) {
    ...
    jQuery('.appdl-bkgd .ihgtranslatortext:eq(0)').prepend('<p class="taoDownloadintro">Join the <strong>Millions of People</strong> Who Have<br> Downloaded the Free IHG&reg; App.</p>');
