jQuery(document).ready(function () {
    ...
    */
    ...
    // jQuery('#taoAccountInfo h2').remove(); // Remove heading "Account Information"
    ...
    jQuery("#taoMailingAddr .taoMailingBlock #countrySelect option:eq(0)").text("Select One");
    ...
    // jQuery('.taoMailingBlock #stateContainer').prepend('<label>State / County / Province: <span>*</span></label>'); // Add missing label
    ...
    jQuery("#taoMailingAddr .taoMailingBlock").last().addClass("taoClear");
    jQuery("#taoMailingAddr .taoMailingBlock").last().hide(); // REMOVING THIS THROWS AN ERROR
