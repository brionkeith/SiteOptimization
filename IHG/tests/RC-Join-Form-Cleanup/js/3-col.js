jQuery(document).ready(function () {
    ...
    // Add 'Terms and Conditions' heading to checkbox parent
    jQuery("<h3>Terms and Conditions</h3>").prependTo(".checkbox.section");
    ...
    // Remove asterisk image
    jQuery('.indicatesRequiredFields img').remove();

    // Change Required field text
    jQuery('#indicatesRequired').text('* Required Field');
    ...
    jQuery('#taoMailingAddr .taoMailingBlock #countrySelect option').first().text('Select One');
    ...
    // alert("THE FOLLOWING BLOCK OF CODE IS NOT WORKING CORRECTLY");
    ...
    jQuery("#taoMailingAddr .taoMailingBlock").last().addClass("taoFlushRight");
    jQuery('#taoMailingAddr .taoMailingBlock #stateSelect option:eq(0)').text('Select One');
    ...
    // Remove Residence/Office Radio Buttons
    jQuery('.taoMailingBlock:eq(6)').remove();
