...
whenReady(
    ...
    {   //this is only necessary if you need to do something on timeout.
        ontimeout: function() {
            ...
            //jQuery('.price-fighter-widget').css('visibility','visible');
        }
    }   //ontimeout
); // whenReady