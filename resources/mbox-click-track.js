...
!function(A) {
    ...
    mboxFactoryDefault.addOnLoad(function(){
        Adbett.track({selector:'PATH TO SELECTOR',value:'PARAM VALUE',event:'mousedown',type:'signaler'});
        Adbett.track({selector:'PATH TO SELECTOR',value:'PARAM VALUE',event:'mousedown',type:'signaler'});
        ...
        // THE FOLLOWING CONDITION CHECKS IF THE CHECKBOX VALUE IS 'CHECKED'
        // IF NOT CHECKED, IGNORE THE MOUSE EVENT AND DO NOT TRACK CLICK IN ADOBE TARGET
