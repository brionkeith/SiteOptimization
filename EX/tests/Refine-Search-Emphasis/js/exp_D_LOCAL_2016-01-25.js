jQuery(document).ready(function (jQuery) {
  ...
  jQuery(document).ajaxComplete(function (event, request, settings) {
    ...
    jQuery('.taoRatings li:eq(1)').addClass('taoFourStars'); // add class names to distinguish ratings
    ...
    jQuery('.taoRatings').prevAll('.taoRatings').remove(); // Remove duplicate 'taoRatings'
    ...
    jQuery('.amenitiesLeftCol .checkbox input:checkbox').on('click', function() {
    ...
    jQuery('.amenitiesLeftCol .dimSelected li:first-child input:checkbox').on('click', function() {
      jQuery(this).attr('disabled', true).prop('checked', true); /* partially working */
      jQuery('.amenitiesLeftCol .dimSelected li:first-child').addClass('disabled active'); /* working */
      jQuery('.amenitiesLeftCol .dimSelected li:gt(0) input, .amenitiesRightCol .dimSelected li input').prop('checked', false); /* working */
    });
