jQuery(document).ready(function (jQuery) {
  ...
  jQuery(document).ajaxComplete(function (event, request, settings) {
    ...
    jQuery('.amenitiesLeftCol li:gt(0) input:checkbox').change(function() {
      if (jQuery(this).prop('checked') === false) {
        jQuery('.amenitiesLeftCol .dimSelected li:first-child').addClass('disabled active'); // add class names
        //alert("An Amenitiy was UNchecked, and 'All Amenities' was disabled.");
      }
    });

    jQuery('.amenitiesLeftCol .dimSelected li input:checkbox, .amenitiesRightCol .dimSelected li input:checkbox').change(function() {
      if (jQuery(this).prop('checked') === false) {
        // If none of the checkboxes are selected check and disable 'All Amenities'
        jQuery('.amenitiesLeftCol input:checkbox:eq(0)').prop('checked', true).attr('disabled', true);
        jQuery('.amenitiesLeftCol .dimSelected li:first-child').addClass('disabled active');
      }
    });
