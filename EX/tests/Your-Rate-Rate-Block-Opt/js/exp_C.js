jQuery(document).ready(function(jQuery){
	...
	jQuery('<p class="taoMemberText"><b>Not a member?</b><br>Choose this great rate and<br><span>join for free</span> while you book.</p>').insertAfter('.bookThisRoomMemberRate');
});