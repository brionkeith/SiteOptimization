...
Once a campaign is deactivated, and deemed a 'winner', a new folder should be created within the <b>test</b> directory, and named 'winner', and indicate the winning experience (ex. Check-Dark). This repo should include sub-folders with all dependent files (i.e COFFEE, CSS, JS, SASS), and shared with the appropriate dev team for rollout to PROD environment.
